...
fn impl_complex_enum_unit_variant_cls(
    ...
    let (_variant_match_args, match_args_method_impl) =
        impl_complex_enum_variant_match_args(ctx, &variant_cls_type, &[])?;
